...
def textToNum(texto_toarr, max_exp):
        acum=0
        cont=0
        base=26
...
def mensajeDesenc(texto_toarr, max_exp):
    
    numCifrado = textToNum(texto_toarr,max_exp)
    #print("El num cifrado es: ",numCifrado)
    numPlano = (numCifrado**d)%n
    #print("El num plano es: ",numPlano)
    #print("el num cifrado es ",numCifrado) 
    #print("el num plano es ", numPlano)
...
if (textToNum(texto_toarr,max_exp) != -1):
    #print(texto_toarr)
